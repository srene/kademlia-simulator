    ...
    if (first) {
      ...
      for (int i = 0; i < Network.size(); i++) {
        ...
        if (i == 0) {
          ...
          int r1 = CommonState.r.nextInt(GossipCommonConfig.BLOCK_DIM_SIZE);
          EDSimulator.add(0, Message.makeInitJoinMessage("Row" + r1), n, protocol);
          int r2 = CommonState.r.nextInt(GossipCommonConfig.BLOCK_DIM_SIZE);
          EDSimulator.add(0, Message.makeInitJoinMessage("Row" + r2), n, protocol);
          int c1 = CommonState.r.nextInt(GossipCommonConfig.BLOCK_DIM_SIZE);
          EDSimulator.add(0, Message.makeInitJoinMessage("Column" + c1), n, protocol);
          int c2 = CommonState.r.nextInt(GossipCommonConfig.BLOCK_DIM_SIZE);
